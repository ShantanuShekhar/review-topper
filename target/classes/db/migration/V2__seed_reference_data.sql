-- Idempotent catalog seed (Liquibase applies SQL before ApplicationRunner).
-- Keeps Starter / Growth / labels / WhatsApp template available on a clean database
-- even if Java bootstrap logic changes later.
